...
WebUI.setText(findTestObject('Book Store Application/txt_password_login'), 'Secure9*')

//WebUI.verifyElementVisible(findTestObject('Book Store Application/checkbox_captcha'))
//
//WebUI.clickOffset(findTestObject('Book Store Application/checkbox_captcha'), 100, 0)
//
...
//
//assert alertText == 'User Register Successfully.'
//
//WebUI.acceptAlert()

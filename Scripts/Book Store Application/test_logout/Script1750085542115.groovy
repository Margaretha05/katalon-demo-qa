...
WebUI.callTestCase(findTestCase('Book Store Application/test_login_success'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Book Store Application/btn_logout'))

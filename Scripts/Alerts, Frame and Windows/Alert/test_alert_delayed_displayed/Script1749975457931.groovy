...
WebUI.scrollToElement(findTestObject('Alerts, Frame and Windows/Alerts/btn_alert_delayed'), 0)

WebUI.click(findTestObject('Alerts, Frame and Windows/Alerts/btn_alert_delayed'))

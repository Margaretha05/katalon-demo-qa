...
WebUI.scrollToElement(findTestObject('Alerts, Frame and Windows/Alerts/btn_alert_prompt'), 0)

WebUI.click(findTestObject('Alerts, Frame and Windows/Alerts/btn_alert_prompt'))
...
assert alertText == 'Please enter your name'

WebUI.setAlertText('Margaretta')

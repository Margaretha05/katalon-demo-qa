...
WebUI.scrollToElement(findTestObject('Alerts, Frame and Windows/Alerts/btn_alert_confirm'), 0)

WebUI.click(findTestObject('Alerts, Frame and Windows/Alerts/btn_alert_confirm'))
...
assert alertText == 'Do you confirm action?'
